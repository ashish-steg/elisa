define(['modules/jquery-mozu', 'underscore', 'modules/api', 'modules/backbone-mozu', 'hyprlivecontext', 'shim!vendor/jquery-colorbox/jquery.colorbox[modules/jquery-mozu=jquery]>jQuery'],
