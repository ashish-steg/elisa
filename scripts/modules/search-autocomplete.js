define(['shim!vendor/typeahead.js/dist/typeahead.bundle[modules/jquery-mozu=jquery]>jQuery', 'hyprlive', 'modules/api'], function($jQuery, Hypr, api) {
    ...
    $jQuery.each(AutocompleteManager.datasets, function(name, set) {
        set.initialize();
    });
    ...
    $jQuery(document).ready(function() {
        var $field = AutocompleteManager.$typeaheadField = $jQuery('[data-mz-role="searchquery"]');
