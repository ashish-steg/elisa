...
define(['backbone'], function(Backbone) {
    ...
    if (Modernizr.history) {
        ...
        Dispatcher.send = function(url) {
             if(window.navigator.userAgent.indexOf("MSIE") > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./) && url.substr(0, window.location.pathname.length) != window.location.pathname){
